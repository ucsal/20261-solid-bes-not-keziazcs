...
- classe tentativa: A lista de respostas estava sendo exposta diretamente, permitindo alterações externas.
...
SRP: nas classes Tentativa e Resposta, evitando que outras partes do sistema manipulem diretamente seus dados internos.
OCP: na classe Questao, removendo valores fixos e tornando a validação de alternativas mais flexível para futuras mudanças.
